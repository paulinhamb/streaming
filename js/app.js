...
function setupWelcomeInteractions() {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  const LAYERS = [
    { sel: '.poster-layer--back',  base: { x: -13, y: -18 }, springK: 0.030, damping: 0.95, entryDelay: 2, entry: { axis: 'x', start: -90 } },
    { sel: '.poster-layer--mid',   base: { x:   0, y:   0 }, springK: 0.055, damping: 0.95, entryDelay: 8, entry: { axis: 'x', start:  90 } },
    { sel: '.poster-layer--front', base: { x:  25, y: -35 }, springK: 0.085, damping: 0.95, entryDelay: 12, entry: { axis: 'y', start:  90 } },
  ].map(cfg => ({
    ...cfg,
